<div class="row">
    <div class="col-md-6">
        <label for="menu" class="mb-0">{{ __('Nombre del Menu') }}</label>
    ...
    <div class="col-sm-6">
        <label for="padre" class="mb-0">{{ __('Padre') }}</label>
...
<div class="row mt-4">
    <div class="col-md-6">
        <label for="ruta" class="mb-0">{{ __('Nombre de la Ruta') }} <small>({{__('La ruta debe existir en el archivo routes.web')}})</small></label>
    ...
    <div class="col-sm-6">
        <label for="nivel" class="mb-0">{{ __('Nivel') }}</label>
