	...
	<div class="container login-page my-4 px-sm-5">
		<div class="row login-register">
			<div class="col col-12 col-sm-6 p-0 login-img">
				<img class="w-80 mb-0 mt-5" src="{{ asset('/images/giftcard/banner.svg') }}">
			</div>
			...
			<div class="col col-12 col-sm-6 p-4 p-sm-5 login-form">
				<ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
					...
					<li class="nav-item">
						@if (is_numeric(substr(URL::full(), strpos(URL::full(), '=') + 1)))
							<a class="nav-link" href="{{ route('register', ['giftcard' => substr(URL::full(), strpos(URL::full(), '=') + 1)]) }}">
								Registrarse
							</a>
						@else
