        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-danger" role="alert">
                    <strong>Aguarda!</strong> ¿Estás seguro de borrar el usuario {{ $user->amount }} {{ $user->surname }}?
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Cerrar</button>
                <button type="button" class="btn btn-danger btn-sm" @click.prevent="deleteUser({{$user->id}})">Eliminar</button>
            </div>
        </div>
    </div>
</div>