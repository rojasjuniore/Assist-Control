                        ...
                        <tr>
                            ...
                            <td class="td-actions text-right">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission.show')): ?>
                                    <a href="<?php echo e(route('permissions.show', $item->id)); ?>" class="btn btn-outline-success btn-round btn-sm">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission.edit')): ?>
                                    <a href="<?php echo e(route('permissions.edit', $item->id)); ?>" class="btn btn-outline-success btn-round btn-sm">
                                        <i class="fas fa-pencil-alt"></i>
                                    </a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission.destroy')): ?>
                                    <?php echo Form::open(['route' => ['permissions.destroy', $item->id], 'method' => 'DELETE', 'id' => 'formDelete','class' => 'd-inline']); ?>
