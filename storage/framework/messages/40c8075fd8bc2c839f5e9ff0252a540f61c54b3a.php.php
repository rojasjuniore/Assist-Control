        ...
        <div class="box box-primary">
            <div class="box-body">
                <div class="row">
                    ...
                    <?php echo Form::model($permission, ['route' => ['permissions.update', $permission->id], 'method'=>'PUT', 'style'=>'width: 100%']); ?>

                    <?php echo $__env->make('permissions.partials.form', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <hr>
