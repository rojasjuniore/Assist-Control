            ...
            <table class="table-header-rotated tablero" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    for ($col_x; $col_x < $cols_limit && $col_x < sizeof($cols); $col_x++) {
                        ...
                        ?>
                        <th class="titulos rotate" style="vertical-align:bottom;cursor:pointer" onClick="document.getElementById('matmed-<?= $cols[$col_x]['idMatMed'] ?>').click()"
                            title="<?= $medicamento ?>">
                            <div><span><?= $medicamento ?></span></div>
                        </th>
                        <?
                    }
                    ?>
                ...
                <tr><!-- SUMA -->
                    ...
                    for ($col_x; $col_x < $cols_limit && $col_x < sizeof($cols); $col_x++) {
                        ...
                        ?>
                        <td align="<?= $cols[$col_x]['align'] ?>" title="<?= $cols[$col_x]['nombre'] ?> - SUMA" style="border-width:thick">
                            <em><strong><?= $cols[$col_x]['suma'] ?></strong></em></td>
                        <?
                    }
                    ?>
                </tr>
