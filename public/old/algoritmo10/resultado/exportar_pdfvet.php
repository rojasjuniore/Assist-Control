...
if( is_file( $file ) ){
	...
	$mail->Username		= "resultado@universidadcandegabe.org";     // SMTP server username
	$mail->Password		= "candegabe123456";            // SMTP server password
	$mail->From       	= "resultado@universidadcandegabe.org";
...
ob_start();
ob_implicit_flush(0);
	include '/algoritmo10/resultado/resultado_pdfvet.php';
...
ob_start();
ob_implicit_flush(0);
	include '/algoritmo10/resultado/index3_vet.php';
	$resultado = ob_get_contents();
ob_end_clean();
ob_flush();
# Volcamos resultados
