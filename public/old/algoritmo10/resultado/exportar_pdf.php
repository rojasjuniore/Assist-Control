<?php
#http://algoritmo.universidadcandegabe.org/index.php?option=com_content&view=article&id=62&Itemid=30&id_estudio=5146&userId=sebastian&emailUser=seba(arr)virtualdata.com.ar&nombre=&apellido=&fid=20140911155935
...
if( is_file( $file ) ){
	...
	$body             	= "Adjunto resultado del Algoritmo Candegabe";		
	$mail->IsSMTP();                           // tell the class to use SMTP
	$mail->SMTPAuth   	= true;                  // enable SMTP authentication
	$mail->Port       	= 25;                    // set the SMTP server port
	$mail->Host			= "mail.algoritmocandegabe.com"; // SMTP server
...
ob_start();
ob_implicit_flush(0);
	include '/algoritmo10/resultado/resultado_pdf.php?id_estudio='.$id_estudio;
...
ob_start();
ob_implicit_flush(0);
	include '/algoritmo10/resultado/index3.php';
	$resultado = ob_get_contents();
ob_end_clean();
ob_flush();
# Volcamos resultados
