...
if( !$estudio->id ) echo "NO SE ENCUENTRA EL ESTUDIO SOLICITADO";
else{
?>
...
<div id="contenedor">
	...
	<div id="resultadoHeader">
		<h2><strong>Resultados del Estudio</strong></h2>
		<div id="tres_btn">
            ...
            <?php } ?>
			<!-- este bono hace link a un artículo joomla usando shadowbox --><a class="btn-light_grey" id="btn-otro_estudio" href="http://<?=$_SERVER['HTTP_HOST']?>/index.php?option=com_content&view=article&id=46&Itemid=53">Realizar otro Estudio</a>
		</div>	<!--   fin tres_btn Div   -->
	</div> <!--   fin resultadoHeader Div   -->
	<!--   FORMULARIO   -->
	<div id="formActualizar">
		<form id="formAlgoritmo" action="http://<?=$_SERVER['HTTP_HOST']?>/index.php?option=com_content&view=article&id=5&Itemid=30" method="post" class="formulario" name="formAlgoritmo">
			<div id="campos_form">	
				<!-- NOMBRE --> 
				<p>
					{tip Nombre/s::Nombres propios: (por ejemplo:María Dolores Amelia)}
					<label for="name">Nombre/s</label>
					<input  name="name" type="text" id="name" tabindex="1" size="30" value="<?php echo $nombre;?>" />
					{/tip} 
				</p>
				<!-- NOMBRE FIN--> 
				<!-- APELLIDO --> 
				<p> 
					...
					<input name="lastName" type="text" id="lastName" tabindex="2" size="30" value="<?php echo $last;?>" />
					{/tip}  
				</p>
		  		<!-- APELLIDO FIN --> 
				<!-- APODO --> 
				<p>
					{tip Apodo::en algunas ocasiones la persona se identifica, no con alguno de sus nombres propios, sino con un &quot;apodo&quot; que reemplaza en importancia a su propio nombre.}
					<label for="apodo" id="apodoLabel">Nombre por el <br />cual se identifica</label>
					<input name="apodo" type="text" id="apodo" tabindex="3" size="30" value="<?php echo $apodo?>" />
					{/tip}  
				</p>
				<!-- APODO FIN --> 
				<!-- INICIALES --> 
				...
				<input name="lug_nac" type="text" id="lug_nac" value="<?php echo $pais?>" readonly /> 
    ...
    <div id="impregnancia">
		<h2>Impregnancia  <img src="/static/img/icon-16-info.png" title="<?=$txt['tooltip_impregnancia']?>" class="tooltip-icon" /></h2>
		<h3>Simetría</h3>
<?php
...
?>
	...
	<h2><a href="#tabla_resultado_completa">Análisis desplegado</a> <img src="/static/img/icon-16-info.png" title="<?=$txt['tooltip_analisis_desplegado']?>"  class="tooltip-icon" /></h2>
	</div>
<div id="filtros_sec">
 ...
 <!--   RESULTADOS DEL ALGORITMO   -->
	<div id="tabla_resultado_completa">
		<div id="tit_list">
			...
			<thead>
				<tr>
					<th colspan="2" class="col_reino">Reino</th>
					...
					<th class="secuencia">Secuencia</th>
				</tr>
			</thead>
<? /*			</table>
...
<div class="sombra_saparador"></div>
	...
	<table id="referencias2">
		...
		<div id="trio_botones-footer">
			...
			<?php } else { ?>
			<a rel="shadowbox;width=1100" class="btn-light_grey" id="btn-interpretacion2" href="index2.php?option=com_content&view=article&id=65">Interpretación de Resultados</a>
			<?php } ?>
			<a class="btn-light_grey" href="index.php?option=com_content&view=article&id=46&Itemid=53">Realizar otro Estudio</a>
