...
<head>
	...
	<title>Study Result - Candegabe Algorithm</title>
...
<div id="trial">
	<h2>TITLE</h2>
    <p>You must have credits for this app to work</p>
    <a href="/index.php?option=com_content&view=article&id=67" id="obtener-abono">Get your Package</a>
</div>
<script type="text/javascript">
...
<div id="contenedor">
	...
	<div id="resultadoHeader">
		...
		<div id="tres_btn">
            ...
            <a class="btn-light_grey" id="btn-interpretacion" href="javascript:showTrial('Interpretación de Resultados')">Reading the Algorithm Results</a>
            <?php } else { ?>
	...
	<div id="formActualizar">
		<form id="formAlgoritmo" action="http://<?=$_SERVER['HTTP_HOST']?>/index.php?option=com_content&view=article&id=5&Itemid=30" method="post" class="formulario" name="formAlgoritmo">
			<div id="campos_form">	
				<!-- NOMBRE --> 
				<p>
					{tip Name/s::Name: (e.g. Susan MArie)}
      ...
      <label for="apodo" id="apodoLabel">Name Normally Used</label>
		  ...
		  <label for="iniciales">Initials</label>
		    ...
		    <input name="year" type="text" id="year" size="4" maxlength="4" value="<?php echo $anio?>" readonly />
				...
				<!-- LUGAR DE NACIMIENTO --> 
				<label for="lug_nac">Birth Place</label>
...
<div id="filtros_sec">
	<input type="button" class="btnFiltroSec" name="btnTodos" id="btnTodos" value="Show All" onClick="showTr( '', 1, 'Mostrar Todos' );" />
	<input type="button" class="btnFiltroSec" name="btnAnimal" id="btnAnimal" value="Animals Only" onClick="showTr( '', 2, 'Sólo Animales' );" />
	<input type="button" class="btnFiltroSec" name="btnVegetal" id="btnVegetal" value="Vegetables Only" onClick="showTr( '', 3, 'Sólo Vegetales' );" />
	<input type="button" class="btnFiltroSec" name="btnMineral" id="btnMineral" value="Minerals Only" onClick="showTr( '', 4, 'Sólo Minerales' );" />
...
<div class="sombra_saparador"></div>
	...
	<table id="referencias2">
		<tr>
			<td><img src="algoritmo10/resultado/min-veg.png" width="33" height="17" alt="Mineral/Vegetable" />Mineral/Vegetable</td>
			<td><img src="algoritmo10/resultado/min-ani.png" width="33" height="17" alt="Mineral/Animal" />Mineral/Animal</td>
			<td><img src="algoritmo10/resultado/veg-ani.png" width="33" height="17" alt="Vegetable/Animal" />Vegetable/Animal</td>
		</tr>
	</table>
