...
<div id="trial">
	<h2>TITULO</h2>
    <p>Debe adquirir un abono para acceder a esta funcionalidad</p>
    <a href="/index.php?option=com_content&view=article&id=67" id="obtener-abono">Obtenga un abono</a>
</div>
<script type="text/javascript">
...
$last = strtoupper($_POST['owner']);
$nombre = strtoupper($_POST['especie']);
$apodo = strtoupper($_POST['petName']);
...
<div id="contenedor">
	...
	<div id="resultadoHeader">
		...
		<div id="tres_btn">
            ...
            <a class="btn-light_grey" id="btn-interpretacion" href="javascript:showTrial('Interpretación de Resultados')">Interpretación de Resultados</a>
            <?php } else { ?>
			<a rel="shadowbox" class="btn-light_grey" id="btn-interpretacion" href="index2.php?option=com_content&view=article&id=65">Interpretación de Resultados</a>
            <?php } ?>
			<!-- este bono hace link a un artículo joomla usando shadowbox --><a class="btn-light_grey" id="btn-otro_estudio" href="http://www.algoritmocandegabe.com/index.php?option=com_content&amp;view=article&amp;id=68&amp;Itemid=53">Realizar otro Estudio</a>
		</div>	<!--   fin tres_btn Div   -->
	</div> <!--   fin resultadoHeader Div   -->
	<!--   FORMULARIO   -->
	<div id="formActualizar">
		<form id="formAlgoritmo" action="http://www.algoritmocandegabe.com/index.php?option=com_content&view=article&id=69&Itemid=30" method="post" class="formulario" name="formAlgoritmo" onsubmit="return false;">
   <!-- NOMBRE --> 
<div id="campos_form">	
	<p>
	  <label for="name">Especie</label>
			<input  name="especie" type="text" id="especie" tabindex="1" size="30" value="<?php echo strtoupper($_POST['especie']);?>" />
	</p>
	<!-- NOMBRE FIN--> 
	<!-- APELLIDO --> 
		<p>
		  <label for="lastName">Nombre del Dueño</label>
			<input name="owner" type="text" id="owner" tabindex="2" size="30" value="<?php echo strtoupper($_POST['owner']);?>" />
		</p>
   <!-- APELLIDO FIN --> 
   <!-- APODO --> 
		<p>
	    <label for="apodo" id="apodoLabel">Nombre del Animal</label>
			<input name="petName" type="text" id="petName" tabindex="3" size="30" value="<?php echo strtoupper($_POST['petName']);?>" />
		</p>
   <!-- APODO FIN --> 
   <!-- INICIALES --> 
		<p>
...
Switch ($pregnancia)
	 {
			...
			echo '<p><a class="btn-light_grey-finito" href="index.php?option=com_content&amp;view=article&amp;id=58&amp;catid=40" title="Orden de Simetría 1">Vea la Dinámica</a></p>
			<p><a class="btn-light_grey-finito" href="#">Interrogatorio Dirigido</a></p>
			' ;
			}
		       break;
		     case 2 :
			...
			';
				...
				echo '<p><a class="btn-light_grey-finito" href="#">Vea la Dinámica</a></p>
				<p><a class="btn-light_grey-finito" href="#">Interrogatorio Dirigido</a></p>
				' ;
			}
		       break;
			...
			';
				...
				echo '<p><a class="btn-light_grey-finito" rel="shadowbox;width=1200" href="index2.php?option=com_content&amp;view=article&amp;id=61&amp;catid=40" title="Orden de Simetría 6">Vea la Dinámica</a></p>
				<p><a class="btn-light_grey-finito" href="#">Interrogatorio Dirigido</a></p>
				' ;
			}
		       break;
...
<div id="filtros_sec">    
	<input type="button" class="btnFiltroSec" name="btnTodos" id="btnTodos" value="Mostrar Todos" onClick="showTr( '', 1, 'Mostrar Todos' );" />
    <input type="button" class="btnFiltroSec" name="btnAnimal" id="btnAnimal" value="Sólo Animales" onClick="showTr( '', 2, 'Sólo Animales' );" />
    <input type="button" class="btnFiltroSec" name="btnVegetal" id="btnVegetal" value="Sólo Vegetales" onClick="showTr( '', 3, 'Sólo Vegetales' );" />
    <input type="button" class="btnFiltroSec" name="btnMineral" id="btnMineral" value="Sólo Minerales" onClick="showTr( '', 4, 'Sólo Minerales' );" />
...
<div id="trio_botones-footer">	
	<?php if( $user->get('usertype') == 'Author' ){ ?>
    <a class="btn-light_grey" id="btn-interpretacion2" href="javascript:showTrial('Interpretación de Resultados')">Interpretación de Resultados</a>
    <?php } else { ?>
    <a rel="shadowbox" class="btn-light_grey" id="btn-interpretacion2" href="index2.php?option=com_content&view=article&id=65">Interpretación de Resultados</a>
    <?php } ?>
    <a class="btn-light_grey" href="http://www.algoritmocandegabe.com/index.php?option=com_content&view=article&id=46&Itemid=53">Realizar otro Estudio</a>
