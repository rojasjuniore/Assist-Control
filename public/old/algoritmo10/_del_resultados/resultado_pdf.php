...
'Noviembre','Diciembre'); 
echo ''.$diapdf.' de '.$meses[$mespdf].' de '.$ano; 
...
?>
  ...
  <tr>
    <td><table width="100%" cellpadding="7" id="data_pac">
        <tr>
          <td class="etiqueta" width="30%">Nombre y Apellido:</td>
          <td class="nom-ape"><?php echo strtoupper($nombre);?> <?php echo strtoupper($last);?></td>
        </tr>
        <tr>
          <td class="etiqueta" width="30%">Nombre por el<br />
            cual se identifica:</td>
        ...
        <tr>
          <td class="etiqueta" width="30%">Lugar de Nacimiento:</td>
...
?><br />
    ...
    del Estudio Algorítmico solicitado para el paciente 
    <br />
    <span class="nombre-cert"><?php echo strtoupper($nombre);?> <?php echo strtoupper($last);?></span><br />
    Conforme a las disposiciones y reglamento 
    <br />
    vigentes las autoridades extienden <br />
    el correspondiente certificado. </div>
