...
<div id="contenedor">
	...
	<div id="resultadoHeader">
		...
		<div id="tres_btn">
            ...
            <a class="btn-light_grey" id="btn-interpretacion" href="javascript:showTrial('Result Interpretation')">Result Interpretation</a>
            <?php } else { ?>
			<a rel="shadowbox" class="btn-light_grey" id="btn-interpretacion" href="index2.php?option=com_content&view=article&id=65">Result Interpretation</a>
            <?php } ?>
			
			<!-- este bono hace link a un artículo joomla usando shadowbox --><a class="btn-light_grey" id="btn-otro_estudio" href="http://www.algoritmocandegabe.com/index.php?option=com_content&amp;view=article&amp;id=68&amp;Itemid=53">Perform Another Study</a>
...
<div id="campos_form">	
   ...
   <!-- APODO --> 
		<p>
	    <label for="apodo" id="apodoLabel">Animal's Name</label>
