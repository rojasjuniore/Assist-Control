...
?>
  ...
  <tr>
    <td><table width="100%" cellpadding="7" id="data_pac">
        <tr>
          <td class="etiqueta" width="30%">Specie:</td>
          <td><?php echo strtoupper($especie);?></td>
        </tr>
        <tr>
          <td class="etiqueta">Owner's Name</td>
          <td><?php echo strtoupper($owner);?></td>
        </tr>
        <tr>
          <td class="etiqueta" width="30%">Animal's Name:</td>
...
?>
    <br />
    AlgoritmoCandegabe.com certifies the realization of the Algorithmic Study requested for the patient of  <?php echo strtolower($especie);?> specie<br />
    Name: <span class="nombre-cert"><?php echo strtoupper($petName);?></span><br />
    Owner: <span class="nombre-cert"><?php echo strtoupper($owner);?></span><br />
