...
<title>Algorithme Candegabe 2009 - Méthode H.U.M.A.</title>
...
<div id="calculadora">
  ...
  <div id="header">
    ...
    <table border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><h1>Algorithme Candegabe</h1>
          <h2>Méthode H.U.M.A.</h2></td>
  ...
  <!-- FORMULARIO -->
  <div id="formulario">
    <form id="algo_inicio" action="http://www.universidadcandegabe.org/algoritmo09/resultado/index_pdfvetfra.php" method="post" name="algo_inicio" onSubmit="return verify()">
      <script language="JavaScript">
	  function algo_inicio_onsubmit(){

if (algo_inicio.especie.value=="") {
alert("La donnée « Espèce » est en vide")
algo_inicio.especie.focus();
return false 
}

if (algo_inicio.owner.value=="") {
alert("La donnée « Nom du Propriétaire » est en vide")
algo_inicio.owner.focus();
return false 
}

if (algo_inicio.petName.value=="") {
alert("La donnée « Nom de l'Animal » est en vide")
algo_inicio.petName.focus();
return false 
}

if (algo_inicio.iniciales.value=="") {
alert("La donnée « Initiales » est en vide")
...
function verify(){
       ...
       msg = "S'il vous plaît Vérifier l'Information Versée: \n\n Espèce: " + document.forms[0].especie.value + "\n Nom du Propriétaire: " + document.forms[0].owner.value + "\n Nom de l'Animal: " + document.forms[0].petName.value + "\n Initiales: " + document.forms[0].iniciales.value + "\n Date de naissance: " + document.forms[0].day.value + "/"+ document.forms[0].month.value +"/"+ document.forms[0].year.value +"\n\n Si Cette Information est Correcte Confirmer Cette Alerte"
       return confirm(msg);
}
      </script>
      <!-- DATOS PERSONALES -->
      ...
      <table id="especieTable" cellpadding="0" cellspacing="0">
        <tr>
          <td class="backL"></td>
          <td class="especieLabel">Espèce</td>
      ...
      <table id="ownerTable" cellpadding="0" cellspacing="0">
        <tr>
          <td class="backL"></td>
          <td class="ownerLabel">Nom du Propriétaire (par lequel le reconnaît)</td>
      ...
      <table id="petNameTable" cellpadding="0" cellspacing="0">
        <tr>
          <td class="backL"></td>
          <td class="petNameLabel">Nom de l'Animal:</td>
      ...
      <table id="inicialesTable" cellpadding="0" cellspacing="0">
        <tr>
          <td class="backL"></td>
          <td class="inicialesLabel">Initiales</td>
      ...
      <table id="fechaTable" cellpadding="0" cellspacing="0">
        <tr>
          <td class="backL"></td>
          <td class="petNameLabel">Date de naissance</td>
...
<div id="submitBoton">
        <table id="submitTable"width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><input  type="submit" name="Enviar" id="Enviar" value="Faire une Consultation" onclick="return algo_inicio_onsubmit()";/></td>
          </tr>
        </table>
      </div>
      <!-- SUBMIT -->
...
<!-- VENTANAS DE HELP -->
<!-- ESPECIE HELP -->
<div id="especieHelp"> <span class="cerrar"><a href="#" onclick="MM_showHideLayers('especieHelp','','hide')">Fermer</a></span>
  <h5>Espèce</h5>
  <p>Il est très important d’introduire les données objectives que vous possédez du patient. Il est indispensable completar de compléter les données correspondantes comme dans l’exemple qui suit:</p>
  <p><strong>Espèce: (par exemple, Chien) </strong></p>
</div>
<!-- ESPECIE HELP -->
<!-- DUEÑO HELP -->
<div id="ownerHelp"> <span class="cerrar"><a href="#" onclick="MM_showHideLayers('ownerHelp','','hide')">Fermer</a></span>
  <h5>Nom du Propriétaire</h5>
  <p>Il est très important d’introduire les données objectives que vous possédez du patient. Il est indispensable completar de compléter les données correspondantes comme dans l’exemple qui suit:</p>
  <p><strong>Nom du Propriétaire (par lequel le reconnaît): (par example, Lola)</strong></p>
</div>
<!-- DUEÑO HELP -->
<!-- Nombre del Animal HELP -->
<div id="petNameHelp"> <span class="cerrar"><a href="#" onclick="MM_showHideLayers('petNameHelp','','hide')">Fermer</a></span>
  <h5>Nom de l'Animal</h5>
  <p>Il est très important d’introduire les données objectives que vous possédez du patient. Il est indispensable completar de compléter les données correspondantes comme dans l’exemple qui suit:</p>
  <p><strong>Nom de l'Animal: (par example, Black)</strong></p>
</div>
<!-- Nombre del Animal HELP -->
<!-- INICIALES HELP -->
<div id="inicialesHelp"> <span class="cerrar"><a href="#" onclick="MM_showHideLayers('inicialesHelp','','hide')">Fermer</a></span>
  <h5>Initiales</h5>
  <p>Il est très important d’introduire les données objectives que vous possédez du patient. Il est indispensable completar de compléter les données correspondantes comme dans l’exemple qui suit:</p>
  <p><strong>Initiales: la première lettre du nom du Propriétaire et la première lettre du nom de l'Animal: (par example, LB)</strong></p>
</div>
<!-- INICIALES HELP -->
<!-- FECHA DE NACIMIENTO HELP -->
<div id="nacimientoHelp"> <span class="cerrar"><a href="#" onclick="MM_showHideLayers('nacimientoHelp','','hide')">Fermer</a></span>
  <h5>Date de naissance</h5>
  <p>Il est très important d’introduire les données objectives que vous possédez du patient. Il est indispensable completar de compléter les données correspondantes comme dans l’exemple qui suit:</p>
  <p><strong>Date de naissance: (par exemple, 23 septembre 1996)</strong></p>
</div>
<!-- FECHA DE NACIMIENTO HELP -->
<!-- VENTANAS DE HELP -->
</body>
