...
<title>Algoritmo Candegabe 2009 - Método H.U.M.A.</title>
...
<div id="calculadora">
  ...
  <div id="header">
    ...
    <table border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><h1>Algoritmo Candegabe</h1>
          <h2>M&eacute;todo H.U.M.A.</h2></td>
  ...
  <!-- FORMULARIO -->
  <div id="formulario">
    <form id="algo_inicio" action="http://www.universidadcandegabe.org/algoritmo09/resultado/index_pdfvetpor.php" method="post" name="algo_inicio" onSubmit="return verify()">
      <script language="JavaScript">
	  function algo_inicio_onsubmit(){

if (algo_inicio.especie.value=="") {
alert("Completar a 'Espécie'")
algo_inicio.especie.focus();
return false 
}

if (algo_inicio.owner.value=="") {
alert("Completar o 'Nome do Proprietário...'")
algo_inicio.owner.focus();
return false 
}

if (algo_inicio.petName.value=="") {
alert("Completar o 'Nome do Animal'")
algo_inicio.petName.focus();
return false 
}

if (algo_inicio.iniciales.value=="") {
alert("Completar as 'Iniciais'")
...
function verify(){
       ...
       msg = "Verificar por favor a Informação Incorporada: \n\n Espécie: " + document.forms[0].especie.value + "\n Nome do Proprietário: " + document.forms[0].owner.value + "\n Nome do Animal: " + document.forms[0].petName.value + "\n Iniciais: " + document.forms[0].iniciales.value + "\n Data de Nascimento: " + document.forms[0].day.value + "/"+ document.forms[0].month.value +"/"+ document.forms[0].year.value +"\n\n Se esta Informação Estiver Correta Confirmar ista Alerta"
       return confirm(msg);
}
      </script>
      <!-- DATOS PERSONALES -->
      ...
      <table id="especieTable" cellpadding="0" cellspacing="0">
        <tr>
          <td class="backL"></td>
          <td class="especieLabel">Espécie</td>
      ...
      <table id="ownerTable" cellpadding="0" cellspacing="0">
        <tr>
          <td class="backL"></td>
          <td class="ownerLabel">Nome do Proprietário (por qual o reconhece)</td>
      ...
      <table id="petNameTable" cellpadding="0" cellspacing="0">
        <tr>
          <td class="backL"></td>
          <td class="petNameLabel">Nome do Animal</td>
      ...
      <table id="inicialesTable" cellpadding="0" cellspacing="0">
        <tr>
          <td class="backL"></td>
          <td class="inicialesLabel">Iniciais</td>
      ...
      <table id="fechaTable" cellpadding="0" cellspacing="0">
        <tr>
          <td class="backL"></td>
          <td class="petNameLabel">Data de Nascimento (dd/mm/aaaa)</td>
...
<div id="submitBoton">
        <table id="submitTable"width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><input  type="submit" name="Enviar" id="Enviar" value="Consultar" onclick="return algo_inicio_onsubmit()";/></td>
          </tr>
        </table>
      </div>
      <!-- SUBMIT -->
...
<!-- VENTANAS DE HELP -->
<!-- ESPECIE HELP -->
<div id="especieHelp"> <span class="cerrar"><a href="#" onclick="MM_showHideLayers('especieHelp','','hide')">Fechar</a></span>
  <h5>Espécie</h5>
  <p>É muito importante informar os dados objetivos que conheça do paciente, sendo imprescindível completar os seguintes campos: nome, sobrenome, nome ou apelido pelo qual se reconheça, data de nascimento e origem do sobrenome:</p>
  <p><strong>Espécie: (por exemplo: Cão)</strong></p>
</div>
<!-- ESPECIE HELP -->
<!-- DUEÑO HELP -->
<div id="ownerHelp"> <span class="cerrar"><a href="#" onclick="MM_showHideLayers('ownerHelp','','hide')">Fechar</a></span>
  <h5>Nome do Proprietário</h5>
  <p>É muito importante informar os dados objetivos que conheça do paciente, sendo imprescindível completar os seguintes campos: nome, sobrenome, nome ou apelido pelo qual se reconheça, data de nascimento e origem do sobrenome:</p>
  <p><strong>Nome do Proprietário (por qual o reconhece): (por exemplo: Loli)</strong></p>
</div>
<!-- DUEÑO HELP -->
<!-- Nombre del Animal HELP -->
<div id="petNameHelp"> <span class="cerrar"><a href="#" onclick="MM_showHideLayers('petNameHelp','','hide')">Fechar</a></span>
  <h5>Nome do Animal</h5>
  <p>É muito importante informar os dados objetivos que conheça do paciente, sendo imprescindível completar os seguintes campos: nome, sobrenome, nome ou apelido pelo qual se reconheça, data de nascimento e origem do sobrenome:</p>
  <p><strong>Nome do Animal: (por exemplo: Black)</strong></p>
</div>
<!-- Nombre del Animal HELP -->
<!-- INICIALES HELP -->
<div id="inicialesHelp"> <span class="cerrar"><a href="#" onclick="MM_showHideLayers('inicialesHelp','','hide')">Fechar</a></span>
  <h5>Iniciais</h5>
  <p>É muito importante informar os dados objetivos que conheça do paciente, sendo imprescindível completar os seguintes campos: nome, sobrenome, nome ou apelido pelo qual se reconheça, data de nascimento e origem do sobrenome:</p>
  <p><strong>Iniciais: a primeira letra do nome do Proprietário e a primeira letra do nome do Animal: (por exemplo: LB)</strong></p>
</div>
<!-- INICIALES HELP -->
<!-- FECHA DE NACIMIENTO HELP -->
<div id="nacimientoHelp"> <span class="cerrar"><a href="#" onclick="MM_showHideLayers('nacimientoHelp','','hide')">Fechar</a></span>
  <h5>Data de Nascimento</h5>
  <p>É muito importante informar os dados objetivos que conheça do paciente, sendo imprescindível completar os seguintes campos: nome, sobrenome, nome ou apelido pelo qual se reconheça, data de nascimento e origem do sobrenome:</p>
  <p><strong>Data de Nascimento (dd/mm/aaaa): (por exemplo: 23/9/1996)</strong></p>
</div>
<!-- FECHA DE NACIMIENTO HELP -->
<!-- VENTANAS DE HELP -->
</body>
