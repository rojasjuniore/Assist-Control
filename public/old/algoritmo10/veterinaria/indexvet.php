...
<div id="calculadora">
  ...
  <!-- FORMULARIO -->
  <div id="formulario">
    <form id="algo_inicio" action="http://www.universidadcandegabe.org/algoritmo09/resultado/index_pdfvet.php" method="post" name="algo_inicio" onSubmit="return verify()">
      <script language="JavaScript">
	  function algo_inicio_onsubmit(){

if (algo_inicio.especie.value=="") {
alert("La Casilla 'Especie' está en Blanco")
algo_inicio.especie.focus();
return false 
}

if (algo_inicio.owner.value=="") {
alert("La Casilla 'Nombre del Dueño...' está en Blanco")
algo_inicio.owner.focus();
return false 
}

if (algo_inicio.petName.value=="") {
alert("La Casilla 'Nombre del Animal' está en Blanco")
algo_inicio.petName.focus();
return false 
}

if (algo_inicio.iniciales.value=="") {
alert("La Casilla 'Iniciales' está en Blanco")
...
function verify(){
      ...
      <table id="especieTable" cellpadding="0" cellspacing="0">
        <tr>
          <td class="backL"></td>
          <td class="especieLabel">Especie</td>
      ...
      <table id="ownerTable" cellpadding="0" cellspacing="0">
        <tr>
          <td class="backL"></td>
          <td class="ownerLabel">Nombre del Due&ntilde;o (por el cual lo reconoce)</td>
      ...
      <table id="petNameTable" cellpadding="0" cellspacing="0">
        <tr>
          <td class="backL"></td>
          <td class="petNameLabel">Nombre del Animal</td>
      ...
      <table id="inicialesTable" cellpadding="0" cellspacing="0">
        <tr>
          <td class="backL"></td>
          <td class="inicialesLabel">Iniciales</td>
      ...
      <table id="fechaTable" cellpadding="0" cellspacing="0">
        <tr>
          <td class="backL"></td>
          <td class="petNameLabel">Fecha de Nacimiento</td>
...
<div id="submitBoton">
        <table id="submitTable"width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><input  type="submit" name="Enviar" id="Enviar" value="Realizar Consulta" onclick="return algo_inicio_onsubmit()";/></td>
          </tr>
        </table>
      </div>
      <!-- SUBMIT -->
...
<!-- VENTANAS DE HELP -->
<!-- ESPECIE HELP -->
<div id="especieHelp"> <span class="cerrar"><a href="#" onclick="MM_showHideLayers('especieHelp','','hide')">Cerrar</a></span>
  <h5>Especie</h5>
  <p>Es de suma importancia ingresar los datos objetivos que conozca del paciente, siendo IMPRESCINDIBLE completar los correspondientes datos como en el ejemplo siguiente:</p>
  <p><strong>Especie: (por ejemplo: Perro)</strong></p>
</div>
<!-- ESPECIE HELP -->
<!-- DUEÑO HELP -->
<div id="ownerHelp"> <span class="cerrar"><a href="#" onclick="MM_showHideLayers('ownerHelp','','hide')">Cerrar</a></span>
  <h5>Nombre del Dueño</h5>
  <p>Es de suma importancia ingresar los datos objetivos que conozca del paciente, siendo IMPRESCINDIBLE completar los correspondientes datos como en el ejemplo siguiente:</p>
  <p><strong>Nombre del Dueño (por el cual el animal reconoce a su dueño): (por ejemplo: a Susana, la dueña, la llaman Susi y el animal la reconoce por su apodo: Susi )</strong></p>
</div>
<!-- DUEÑO HELP -->
<!-- Nombre del Animal HELP -->
<div id="petNameHelp"> <span class="cerrar"><a href="#" onclick="MM_showHideLayers('petNameHelp','','hide')">Cerrar</a></span>
  <h5>Nombre del Animal</h5>
  <p>Es de suma importancia ingresar los datos objetivos que conozca del paciente, siendo IMPRESCINDIBLE completar los correspondientes datos como en el ejemplo siguiente:</p>
  <p><strong>Nombre del Animal: (por ejemplo: Black)</strong></p>
</div>
<!-- Nombre del Animal HELP -->
<!-- INICIALES HELP -->
<div id="inicialesHelp"> <span class="cerrar"><a href="#" onclick="MM_showHideLayers('inicialesHelp','','hide')">Cerrar</a></span>
  <h5>Iniciales</h5>
  <p>Es de suma importancia ingresar los datos objetivos que conozca del paciente, siendo IMPRESCINDIBLE completar los correspondientes datos como en el ejemplo siguiente:</p>
  <p><strong>Iniciales: la primer letra del nombre del Dueño y la primer letra del nombre del Animal: (por ejemplo: LB)</strong></p>
</div>
<!-- INICIALES HELP -->
<!-- FECHA DE NACIMIENTO HELP -->
<div id="nacimientoHelp"> <span class="cerrar"><a href="#" onclick="MM_showHideLayers('nacimientoHelp','','hide')">Cerrar</a></span>
  <h5>Fecha de Nacimiento</h5>
  <p>Es de suma importancia ingresar los datos objetivos que conozca del paciente, siendo IMPRESCINDIBLE completar los correspondientes datos como en el ejemplo siguiente:</p>
  <p><strong>Fecha de Nacimiento: (por ejemplo: 23 del 9 de 1996)</strong></p>
</div>
<!-- FECHA DE NACIMIENTO HELP -->
<!-- VENTANAS DE HELP -->
</body>
